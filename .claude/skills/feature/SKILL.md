...
5. **APPROVED de cierre** (criterios de cierre del doc cumplidos) → IMPLEMENTATION.md marca el feature cerrado, STATUS.md → "esperando OK" → commit de cierre → RECAP (estructura y aviso: skill `recap` — llegás por trabajo autónomo, va push) → **terminá el turno**. No sigas trabajando. (Los commits de cierre no mueven la base: los verifica la ronda 1 del ciclo siguiente — regla del contrato.)
