...
- **Commits no revisados y el cierre consolidado** (r2 de este ciclo — los dos momentos son distintos y se cubren distinto):
  ...
  - **Post-OK**: el commit de cierre consolidado (pasa los features a "Cerrado", cierra el ledger, registra el OK) **no existe al presentar el RECAP** y por eso no puede viajar listado en él. Lo cubre la **excepción del commit de registro del OK** del contrato ([review-contract.md](review-contract.md), incorporada en r3 de este ciclo): transcripción mecánica de un OK ya recibido, cubierta por ese OK, con contenido estrictamente acotado a los estados en IMPLEMENTATION, STATUS y el cierre del ledger. El barrido por la r1 del ciclo siguiente queda como **auditoría normal cuando ese ciclo existe** — no como única cobertura: si el lote agotó el backlog y sigue una pausa larga, la excepción alcanza sola. Si el cierre necesitara sustancia más allá de la transcripción, no va en ese commit: es trabajo nuevo y pasa por el loop.
