...
> **Revertida el 2026-07-29 por el feature 11** ([11-subagent-models.md](11-subagent-models.md)): por pedido humano, la maquinaria **sí** fija el modelo de los hijos por tipo de unidad. El texto de abajo se conserva íntegro porque su razón de fondo no desapareció — se convirtió en la pregunta que la bajada del 11 tuvo que responder, y la respondió con tres defensas: **alias de familia** (`fable`/`opus`, no IDs de API versionados, así que no envejecen), **degradación anunciada** ante indisponibilidad (el destino nunca queda bloqueado, y la degradación queda en el ledger y en el RECAP) y el **override por gate**, que se conserva. Lo que sí cambia de estatus es el argumento (a): el esquema de modelo por fase deja de ser solo elección del humano para la **sesión** — el de los **hijos** pasa a ser regla de la maquinaria, y `AGENTS.md` §Roles distingue ambos planos.
