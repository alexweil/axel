...
| 05 | Confirmación previa a la implementación en `/feature` | **En curso** — gate manual confirmado (2026-07-28); bajada APPROVED (r2); implementación en review | [implementation/05-feature-gate.md](implementation/05-feature-gate.md) |
