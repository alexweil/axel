...
| 07 | Batch de features: `/feature all` y `/feature NN..MM` | **Cerrado** — APPROVED de Codex (r8), 2026-07-28; esperando OK humano del RECAP | [implementation/07-batch-features.md](implementation/07-batch-features.md) (diseño en [design/batch-features.md](design/batch-features.md)) |
