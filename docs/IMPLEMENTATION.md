...
**Extensión 2026-07-28 (feature 07)**: ciclo de `/plan` en curso — único ítem del backlog nuevo; posición fijada por la secuencia que el propio humano marcó (criterio 1: pidió el diseño del batch, lo aprobó el 2026-07-28 y ordenó incorporarlo al plan como paso siguiente). Encaja además en el criterio 3: toca el núcleo del loop (`review.sh`, skill `feature`, la regla dura de continuidad). Acuerdo entre agentes pendiente.
