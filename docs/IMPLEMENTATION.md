...
| 07 | Batch de features: `/feature all` y `/feature NN..MM` | **Pendiente** — bajada fina al arrancar su `/feature` | — (la crea su bajada fina; diseño en [design/batch-features.md](design/batch-features.md)) |
