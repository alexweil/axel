...
| 07 | Batch de features: `/feature all` y `/feature NN..MM` | **En curso** — confirmación de arranque 2026-07-28; bajada fina en review | [implementation/07-batch-features.md](implementation/07-batch-features.md) (diseño en [design/batch-features.md](design/batch-features.md)) |
