...
| 07 | Batch de features: `/feature all` y `/feature NN..MM` | **En curso** — bajada aprobada (r3); implementación (pasos A y B) en revisión de cierre | [implementation/07-batch-features.md](implementation/07-batch-features.md) (diseño en [design/batch-features.md](design/batch-features.md)) |
