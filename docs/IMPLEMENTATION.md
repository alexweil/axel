...
| 06 | One-liner corto: defaults del bootstrap remoto | **En curso** — arranque confirmado por el humano (2026-07-28); bajada fina en review | [implementation/06-oneliner-defaults.md](implementation/06-oneliner-defaults.md) |
