...
- **Último veredicto**: CHANGES_REQUESTED · ronda 2 · head `a7adbf6` (unidad `feature` 15, pipeline 2026-08-05) — seis puntos, los seis aceptados sin argumentar; D4/C10 (siete sustancias) y C15 (13 líneas contra un umbral de 18) quedaron cerrados
