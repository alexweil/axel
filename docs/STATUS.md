...
- **Unidad en curso**: `design` (design-delta) — superficie pública de axel: posicionamiento, política de idioma, licencia y evidencia auditable. Corre con `opus` (degradación anunciada: `fable` rechazado por falta de créditos en la cuenta; registrada en el ledger). Backlog vacío (los doce features del plan cerrados); la ruta agrega los features 13 y 14
- **Ronda de review**: —
