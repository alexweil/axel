...
- **Feature en curso**: **15 — README simple**, unidad `feature` del pipeline **en curso**, hijo lanzado con `opus` (token `0F7F8469…`, SHA inicio `87ee282`); unidades `design` y `plan` **APPROVED — pendiente OK de pipeline** (design: r3, head `4a60531`; plan: r2, head `75e192a`)
- **Ronda de review**: —
